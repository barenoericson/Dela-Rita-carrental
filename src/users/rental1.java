 ...
 */
public class rental1 extends javax.swing.JFrame {
...
if (rowIndex < 0) {
    JOptionPane.showMessageDialog(null, "Please Select an Item!", "Selection Error", JOptionPane.WARNING_MESSAGE);
        ...
        JOptionPane.showMessageDialog(null, "You can't print a transaction of others!", "Selection Error", JOptionPane.WARNING_MESSAGE);
} else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rental1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
